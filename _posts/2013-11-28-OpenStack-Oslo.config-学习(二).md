...
上一篇博客简单的介绍了[Olso.config的背景和使用方法](http://www.choudan.net/2013/11/28/OpenStack-Oslo.config-学习%28二%29.html)，这一篇博客中，我们尝试去分析下其源码。在分析其源码之前，自己有些许困惑，分析其源码是否有必要，就算分析完之后，又能有什么收获！这个一直伴随着我看源码的过程，最后将在末尾写出自己的一点感想。
